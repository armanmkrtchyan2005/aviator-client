interface AirplaneProps extends React.SVGAttributes<SVGSVGElement> {}

export const Airplane: React.FC<AirplaneProps> = ({ ...props }) => {
    return (
        <svg
            {...props}
            id="airplane"
        ...
        >
            <g
                transform="translate(0,253) scale(0.08,-0.08)"
                fill="#E50539"
                stroke="none"
            >
                <path
